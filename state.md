...
build_tool("test") --> llm_request("rewrite_code_req_prompt_template",[question,code,tests,output]) : (false,output)
llm_request("rewrite_code_req_prompt_template",[question,code,tests,output]) --> extract_number(code_or_test_response) : code_or_test_response
extract_number(code_or_test_response) --> llm_request("rewrite_code_prompt_template",[question,code,output]) : 1
extract_number(code_or_test_response) --> llm_request("rewrite_test_prompt_template",[question,code,tests,output]) : 2
llm_request("rewrite_test_prompt_template",[question,code,tests,output]) --> extract_code(test_response) : test_response
...
extract_number(add_dependency_response) --> llm_request("rewrite_code_prompt_template",[question,code,output]) : 2
