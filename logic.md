...
llm_request("rewrite_dependencies",[question,code,dependencies,tests,output]) --> extract_code(update_dependencies_response) : update_dependencies_response
extract_code(update_dependencies_response) --> create_project(code,dependencies,tests,"test_dependencies") : dependencies
